...
Simulink.Bus.cellToObject({
{
	...
	{'m8',		1,'cm20PTMotorIn', -1, 'real', 'Sample'};
	{'m9',		1,'cm20PTMotorIn', -1, 'real', 'Sample'};
	{'m10',		1,'cm20PTMotorIn', -1, 'real', 'Sample'};
	{'m11',		1,'cm20PTMotorIn', -1, 'real', 'Sample'};
    }
}
{
    'cm20PTMotorOut_InArray', {
	...
	{'m8',		1,'cm20PTMotorOut_In', -1, 'real', 'Sample'};
	{'m9',		1,'cm20PTMotorOut_In', -1, 'real', 'Sample'};
	{'m10',		1,'cm20PTMotorOut_In', -1, 'real', 'Sample'};
	{'m11',		1,'cm20PTMotorOut_In', -1, 'real', 'Sample'};
    }
}
{
    'cm20PTMotorOutArray', {
	...
	{'m8',		1,'cm20PTMotorOut', -1, 'real', 'Sample'};
	{'m9',		1,'cm20PTMotorOut', -1, 'real', 'Sample'};
	{'m10',		1,'cm20PTMotorOut', -1, 'real', 'Sample'};
	{'m11',		1,'cm20PTMotorOut', -1, 'real', 'Sample'};
    }
}
{
    'cm20PTMotorArray', {
	...
	{'m8',		1,'cm20PTMotor', -1, 'real', 'Sample'};
	{'m9',		1,'cm20PTMotor', -1, 'real', 'Sample'};
	{'m10',		1,'cm20PTMotor', -1, 'real', 'Sample'};
	{'m11',		1,'cm20PTMotor', -1, 'real', 'Sample'};
    }
}
});
end
