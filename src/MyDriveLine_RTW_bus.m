...
Simulink.Bus.cellToObject({
{
	...
	{'RL3',	1,'cm13WheelIn', -1, 'real', 'Sample'};
	{'RR3',	1,'cm13WheelIn', -1, 'real', 'Sample'};
	{'RL4',	1,'cm13WheelIn', -1, 'real', 'Sample'};
	{'RR4',	1,'cm13WheelIn', -1, 'real', 'Sample'};
    }
}
{
    'cm13DriveInArray', {
	...
	{'d8',	1,'cm13DriveIn', -1, 'real', 'Sample'};
	{'d9',	1,'cm13DriveIn', -1, 'real', 'Sample'};
	{'d10',	1,'cm13DriveIn', -1, 'real', 'Sample'};
	{'d11',	1,'cm13DriveIn', -1, 'real', 'Sample'};
    }
}
{
    'cm13WheelOutArray', {
	...
	{'RL3',	1,'cm13WheelOut', -1, 'real', 'Sample'};
	{'RR3',	1,'cm13WheelOut', -1, 'real', 'Sample'};
	{'RL4',	1,'cm13WheelOut', -1, 'real', 'Sample'};
	{'RR4',	1,'cm13WheelOut', -1, 'real', 'Sample'};
    }
}
{
    'cm13Wheels', {
...
}
{
	...
	{'d8',	1,'cm13DriveOut', -1, 'real', 'Sample'};
	{'d9',	1,'cm13DriveOut', -1, 'real', 'Sample'};
	{'d10',	1,'cm13DriveOut', -1, 'real', 'Sample'};
	{'d11',	1,'cm13DriveOut', -1, 'real', 'Sample'};
    }
}
{
    'cm13DriveSourceArray', {
