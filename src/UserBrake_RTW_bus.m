...
%% Car and Truck Bus
	...
	Simulink.Bus.cellToObject({
	{
		...
		{'RL3',	1,'cm4BrakeWheelIn', -1, 'real', 'Sample'};
		{'RR3',	1,'cm4BrakeWheelIn', -1, 'real', 'Sample'};
		{'RL4',	1,'cm4BrakeWheelIn', -1, 'real', 'Sample'};
		{'RR4',	1,'cm4BrakeWheelIn', -1, 'real', 'Sample'};
	    }
	}
	{
	    'cm4BrakeWheelOutArray', {
		...
		{'RL3',	1,'cm4BrakeWheelOut', -1, 'real', 'Sample'};
		{'RR3',	1,'cm4BrakeWheelOut', -1, 'real', 'Sample'};
		{'RL4',	1,'cm4BrakeWheelOut', -1, 'real', 'Sample'};
		{'RR4',	1,'cm4BrakeWheelOut', -1, 'real', 'Sample'};
	    }
	}
	{
	    'cm4DriveSrcArray', {
