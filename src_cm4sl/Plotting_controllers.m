% Set the save path
savePath = 'D:\Thesis\Testing_and_results\CarMaker_results\Emergency braking';
...
figure;
hold on;
plot(Time,Brake_command, 'b-', 'LineWidth', 2, 'DisplayName', '32 m/s speed');
%plot(Time15,Brake_command15, 'r-', 'LineWidth', 2, 'DisplayName', '15 m/s speed');
%plot(Time40,Brake_command40, 'g-', 'LineWidth', 2, 'DisplayName', '30 m/s speed');
...
% subplot(2, 1, 1);
% hold on;
% plot(Time, CarYaw, 'b-', 'LineWidth', 2, 'DisplayName', '32 m/s speed');
% plot(Time15, CarYaw15, 'r-', 'LineWidth', 2, 'DisplayName', '15 m/s speed');
% plot(Time40,CarYaw40, 'g-', 'LineWidth', 2, 'DisplayName', '30 m/s speed');
% xlabel('Time [s]', 'FontSize', 14);
...
% subplot(2, 1, 2);
% hold on;
% plot(Time,CarYaw_rate, 'b-', 'LineWidth', 2, 'DisplayName', '32 m/s speed');
% plot(Time15, CarYaw_rate15, 'r-', 'LineWidth', 2, 'DisplayName', '15 m/s speed');
% plot(Time40,CarYaw_rate40, 'g-', 'LineWidth', 2, 'DisplayName', '30 m/s speed');
% xlabel('Time [s]', 'FontSize', 14);
...
figure;
hold on;
plot(Time,Slip_angle, 'b-', 'LineWidth', 2, 'DisplayName', '32 m/s speed');
%plot(Time15,Slip_angle15, 'r-', 'LineWidth', 2, 'DisplayName', '15 m/s speed');
%plot(Time40,Slip_angle40, 'g-', 'LineWidth', 2, 'DisplayName', '30 m/s speed');
xlabel('Time [s]', 'FontSize', 14);
...
subplot(2, 2, 1);
hold on;
plot(Time,FLTrq_Brake, 'b-', 'LineWidth', 2, 'DisplayName', '32 m/s speed');
%plot(Time15,FLTrq_Brake15, 'r-', 'LineWidth', 2, 'DisplayName', '15 m/s speed');
%plot(Time40,FLTrq_Brake40, 'g-', 'LineWidth', 2, 'DisplayName', '30 m/s speed');
xlabel('Time [s]', 'FontSize', 14);
...
subplot(2, 2, 2);
hold on;
plot(Time,FRTrq_Brake, 'b-', 'LineWidth', 2, 'DisplayName', '32 m/s speed');
%plot(Time15,FRTrq_Brake15, 'r-', 'LineWidth', 2, 'DisplayName', '15 m/s speed');
%plot(Time40,FRTrq_Brake40, 'g-', 'LineWidth', 2, 'DisplayName', '30 m/s speed');
xlabel('Time [s]', 'FontSize', 14);
...
subplot(2, 2, 3);
hold on;
plot(Time,RLTrq_Brake, 'b-', 'LineWidth', 2, 'DisplayName', '32 m/s speed');
%plot(Time15,RLTrq_Brake15, 'r-', 'LineWidth', 2, 'DisplayName', '15 m/s speed');
%plot(Time40,RLTrq_Brake40, 'g-', 'LineWidth', 2, 'DisplayName', '30 m/s speed');
xlabel('Time [s]', 'FontSize', 14);
...
subplot(2, 2, 4);
hold on;
plot(Time,RRTrq_Brake, 'b-', 'LineWidth', 2, 'DisplayName', '32 m/s speed');
%plot(Time15,RRTrq_Brake15, 'r-', 'LineWidth', 2, 'DisplayName', '15 m/s speed');
%plot(Time40,RRTrq_Brake40, 'g-', 'LineWidth', 2, 'DisplayName', '30 m/s speed');
xlabel('Time [s]', 'FontSize', 14);
...
figure;
hold on;
plot(Time,Speed, 'r-', 'LineWidth', 2, 'DisplayName', '15 m/s speed');
xlabel('Time [s]', 'FontSize', 14);
ylabel('Speed [m/s]', 'FontSize', 14);
title('Vehicle Speed at Different Speeds', 'FontSize', 16);
legend('Location', 'Best', 'FontSize', 12);
hold off;
title('Speed_controller', 'FontSize', 16);
% ... Repeat similar blocks for other variables ...
...
% figure;
% hold on;
% plot(Time,Steering, 'b-', 'LineWidth', 2, 'DisplayName', '32 m/s speed');
% plot(Time15,Steering15, 'r-', 'LineWidth', 2, 'DisplayName', '15 m/s speed');
% plot(Time40,Steering40, 'g-', 'LineWidth', 2, 'DisplayName', '30 m/s speed');
% xlabel('Time [s]', 'FontSize', 14);
...
% figure;
% hold on;
% plot(Time,Throttle, 'b-', 'LineWidth', 2, 'DisplayName', '32 m/s speed');
% plot(Time15,Throttle15, 'r-', 'LineWidth', 2, 'DisplayName', '15 m/s speed');
% plot(Time40,Throttle40, 'g-', 'LineWidth', 2, 'DisplayName', '30 m/s speed');
% xlabel('Time [s]', 'FontSize', 14);
...
% figure;
% hold on;
% plot(Time,Traj_error, 'b-', 'LineWidth', 2, 'DisplayName', '32 m/s speed');
% plot(Time15,Traj_error15, 'r-', 'LineWidth', 2, 'DisplayName', '15 m/s speed');
% plot(Time40,Traj_error40, 'g-', 'LineWidth', 2, 'DisplayName', '30 m/s speed');
% xlabel('Time [s]', 'FontSize', 14);
